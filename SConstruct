...
env = Environment(CCFLAGS='-O3 -std=gnu99 -DCVPI_ASSEMBLY=1 -DCVPI_CAREFUL=1 -DHAVE_BCM_HOST=1 -DCVPI_LOGGING=1',
...
env.Library('libcvpi', [Glob('src/*.c')], LIBS=['m', 'EGL', 'GLESv2', 'bcm_host'], LIBPATH=['/opt/vc/lib'])
